...
extern pd_t *pd_allocate();
// in frame.c
extern void initialize_frame();
extern void initialize_fifolist();
extern void initialize_gca_dirtylist();
extern frame_t *frame_allocate();
extern frame_t *obtain_free_frame();
extern frame_t *get_pageframe_by_policy();
extern frame_t *get_pageframe_by_fifo();
extern frame_t *get_pageframe_by_gca();
extern void insert_pageframe_intolist(int32);
extern void gca_dirtylist_reset();
// in assemble.c
extern void set_cr3(uint32);
extern uint32 read_cr0();
extern uint32 read_cr2();
extern uint32 read_cr3();
extern void enablepaging();
extern void show32(uint32);
// in pagefault_isr.c
//extern void pagefault_isr(void);
// in pfisr.S
extern void pfisr();
// in pagefault_handler.c
extern void pagefault_handler();
// in backstore.c
extern void initializ_bs();
extern int32 bslookup_store(int pid, uint32 vaddr);
extern int32 bslookup_pageoffset(int pid, uint32 vaddr);
