...
#define PIPELINE0           25	/* type pip      */
#define PIPELINE1           26	/* type pip      */
#define PIPELINE2           27	/* type pip      */
#define PIPELINE3           28	/* type pip      */
#define PIPELINE4           29	/* type pip      */
#define PIPELINE5           30	/* type pip      */
#define PIPELINE6           31	/* type pip      */
#define PIPELINE7           32	/* type pip      */
#define PIPELINE8           33	/* type pip      */
#define PIPELINE9           34	/* type pip      */
